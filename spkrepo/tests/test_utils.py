...
from spkrepo.tests.common import BaseTestCase, BuildFactory, create_spk, create_info
...
class SPKParseTestCase(BaseTestCase):
    ...
    def test_wrong_conf_dependencies_encoding(self):
        build = BuildFactory.build(version__conf_dependencies=json.dumps({'déçu': {'dsm_min_ver': '5.0-4300'}}))
