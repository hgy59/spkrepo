...
from ..ext import db
from ..models import Build, Version, user_datastore, DisplayName, Description, Package
...
def profile():
    ...
    return render_template('frontend/profile.html', change_password_form=ChangePasswordForm(),
...
def packages():
    ...
    versions = Version.query.\
        ...
        options(db.joinedload(Version.package),
